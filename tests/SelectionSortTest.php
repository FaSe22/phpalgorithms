...
final class SelectionSortTest extends TestCase
{
    ...
    {
        $this->assertEquals([1,2,3,4,5,6,7,8,9], SelectionSort::sort($arr));
    }
    ...
    */
    ...
    {
        $this->assertEquals([4], SelectionSort::sort([4]));
    }

    #[Test]
    public function test_empty_array(): void
    {
        $this->assertEquals([], SelectionSort::sort([]));
    }

    #[Test]
    public function it_should_sort_non_consecutive_numbers_correctly(): void
    {
        $this->assertEquals([2,5,6,8,9], SelectionSort::sort([5,9,6,2,8]));
    }
    ...
    public function it_can_sort_array_with_1000_elements(): void
    {
        $random = range(1, 1000);
        shuffle($random);
        $this->assertEquals(range(1, 1000), SelectionSort::sort($random));
    }
}
