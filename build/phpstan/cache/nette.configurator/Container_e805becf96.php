...
class Container_e805becf96 extends _PHPStan_95cdbe577\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_e805becf96 $container)
			{
	...
	public function createServiceContainer(): Container_e805becf96
	{
		return $this;
	}
