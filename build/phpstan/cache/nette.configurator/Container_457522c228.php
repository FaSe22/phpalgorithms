...
class Container_457522c228 extends _PHPStan_95cdbe577\Nette\DI\Container
{
	protected $tags = [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'paths' => [
				...
				'/Users/sebastianfaber/Projects/phpalgorithms/tests',
			],
			'exceptions' => [
				'implicitThrows' => true,
	...
	public function createService047(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_457522c228 $container)
			{
	...
	public function createServiceContainer(): Container_457522c228
	{
		return $this;
	}
