...
class Container_2aae53a3e5 extends _PHPStan_95cdbe577\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_2aae53a3e5 $container)
			{
	...
	public function createServiceContainer(): Container_2aae53a3e5
	{
		return $this;
	}
